...
// SSHConfig contains every keyword known to exist in the
...
//
// Please note that rig only supports a very limited subset
// of these settings. This struct exists mainly for the
// purpose of copy-pasting fields into a subset-struct
// that contains only the fields that are supported or
// are relevant for the task in hand. The SSH config
// parser should have no problems parsing values into
// this struct though.
